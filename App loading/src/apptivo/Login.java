...
public class Login {
	...
	static {
		...
		driver.get("https://staging.apptivo.net/");
	...
	private static void userLogin() {
		...
		driver.get("https://staging.apptivo.net/login/");

		driver.findElement(By.name("login_email")).sendKeys("classictest@berijam.com");
		...
		if ("https://staging.apptivo.net/firm-selection/".equals(driver.getCurrentUrl())) {
	...
	private static void CalendarApploading() {
		...
		driver.get("https://staging.apptivo.net/app/home.jsp#/my-agenda/calendar-view");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/home.jsp#/my-agenda/calendar-view".equals(driver.getCurrentUrl())) {
...
//
//		driver.get("https://staging.apptivo.net/app/answers.jsp#/home");
//		try {
//			Thread.sleep(8000);
//		} catch (InterruptedException e) {
//			e.printStackTrace();
...
//		// System.out.println(driver.getCurrentUrl());
//
//		if ("https://staging.apptivo.net/app/answers.jsp#/home".equals(driver.getCurrentUrl())) {
...
//	}
	...
	private static void AppbuilderApploading() {
		...
		driver.get("https://staging.apptivo.net/app/appbuilder.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/appbuilder.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CampaignsApploading() {
		...
		driver.get("https://staging.apptivo.net/app/campaigns.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(8000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/campaigns.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CandidatesApploading() {
		...
		driver.get("https://staging.apptivo.net/app/candidates.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/candidates.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CasesApploading() {
		...
		driver.get("https://staging.apptivo.net/app/cases.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/cases.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CashmanagementApploading() {
		...
		driver.get("https://staging.apptivo.net/app/cashmanagement.jsp#!/home");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/cashmanagement.jsp#!/home".equals(driver.getCurrentUrl())) {
	...
	private static void CompetitorstApploading() {
		...
		driver.get("https://staging.apptivo.net/app/competitors.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/competitors.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void ContactsApploading() {
		...
		driver.get("https://staging.apptivo.net/app/contacts.jsp#/dashboard/byqueue/mycontacts");
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/contacts.jsp#/dashboard/byqueue/mycontacts"
	...
	private static void ContractsApploading() {
		...
		driver.get("https://staging.apptivo.net/app/contracts.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/contracts.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CreditnotesApploading() {
		...
		driver.get("https://staging.apptivo.net/app/creditnotes.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/creditnotes.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CrninsightsApploading() {
		...
		driver.get("https://staging.apptivo.net/app/crninsights.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/crninsights.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CrnApploading() {
		...
		driver.get("https://staging.apptivo.net/app/crn.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/crn.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
	...
	private static void CustomerpaymentsApploading() {
		...
		driver.get("https://staging.apptivo.net/app/customerpayments.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/customerpayments.jsp#/dashboard/show-all/"
				.equals(driver.getCurrentUrl())) {
	...
	private static void CustomerApploading() {
		...
		driver.get("https://staging.apptivo.net/app/customers.jsp#/dashboard/show-all/");
		try {
			Thread.sleep(7000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if ("https://staging.apptivo.net/app/customers.jsp#/dashboard/show-all/".equals(driver.getCurrentUrl())) {
